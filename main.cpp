...
int main(){
    ...
    for (int i = 0; i < 25; ++i) {
        vec.push_back(i);
        cout << "Pushed back: " << i << ", size: " << vec.size() << ", capacity: " << vec.capacity() << "\n";
    }
    ...
    // Resize the vector
    vec.resize(30);
    cout << "Resized to 30, new size: " << vec.size() << ", capacity: " << vec.capacity() << "\n";
    ...
    cout << "Inserted " << valToInsert << " at position 2, new size: " << vec.size() << "\n";
    ...
    // Sort the list (requires sorting logic, assumes list is not empty)
    cout << "Sorting the list" << endl;
    cll.sort();
    cll.printList();
    ...
    // Trying to get the maximum and minimum from an empty stack (this will throw an exception)
    try {
        cout << "Maximum element: " << stack.maxele() << endl;
    ...
    cout << "Extracting minimum element: " << minheap.extractMin() << endl;
    cout << "Extracting another minimum element: " << minheap.extractMin() << endl;
    ...
    // Extract more elements and display them
    cout << "Extracting maximum element: " << maxheap.extractMax() << endl;
    cout << "Extracting another maximum element: " << maxheap.extractMax() << endl;
    ...
    // Tree height
    cout << "Height of the tree: " << bst.getHeight(bst) << endl;
    ...
    cout << "Does the graph have a cycle? " << (hasCycle ? "Yes" : "No") << endl;
    ...
    if (shortestDistance != -1) {
        cout << "Shortest path from node " << startNode << " to node " << endNode << " is: " << shortestDistance << endl;
    } else {
    ...
    cout << "Does a path exist from node " << startNode << " to node " << endNode << "? " << (pathExists ? "Yes" : "No") << endl;
    ...
    int shortestDistance = directedGraph.shortestPath(0, 4);
    if (shortestDistance != -1) {
    ...
    try {
        customVector<int> topoSort = directedGraph.toposort();
    ...
    // Reverse the graph
    DirectedGraph<int> reversedGraph = directedGraph.reverse();
